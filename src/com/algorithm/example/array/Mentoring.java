...
public class Mentoring {
  public static void main(String[] args) {
    ...
    int[][] arr = new int[studentCount][testCount];
    ...
    System.out.println(solution(arr, studentCount, testCount));
  }

  private static int solution(int[][] arr, int studentCount, int testCount) {
    int result = 0;
